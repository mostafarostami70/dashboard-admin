  ...
  return (
    <>
      ...
      <Breadcrump
        links={[
          { id: 1, title: 'خانه ', to: '' },
          { id: 2, title: 'اجتماعی', to: 'category-info/social' },
          { id: 3, title: 'اعتیاد', to: 'course-info/etiad' },
        ]} />
          ...
          <div class="row">
            <div class="col-8">
              <div class="course">
                ...
                {/* این بخش به صورت اچ تی ام ال تمپلیت از طرف بک اند ارسال میشه
                  چون ممکنه هر انتروداکشن اطلاعات و تصاویر متفاوتی با بقیه داشته باشه و ساختارش 
                  متفاوت باشه */}
                {/* <!-- Start Introduction --> */}
                  ...
                  <div class="introduction__topic">
                    ...
                    <Accordion open={open} toggle={toggle}>
                      <AccordionItem className="accordion">
                        <AccordionHeader targetId="1">معرفی دوره</AccordionHeader>
                      ...
                      <AccordionItem className="accordion">
                        <AccordionHeader targetId="2">معرفی دوره</AccordionHeader>
                  ...
                  <div class="techer-details__header">
                    <div class="techer-details__header-right">
                      ...
                      <div class="techer-details__header-titles">
                        <a href="#" class="techer-details__header-link">مصطفی رستمی</a>
