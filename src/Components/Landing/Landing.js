            ...
            <div class="container">
                ...
                <h1 class="landing__title">
                    <Typewriter
                        ...
                        options={{
                            strings: ['ما به هر قیمتی پکیج آماری تولید نمی کنیم !',
                                'نمی مانیم تا فردا بیاید، میرویم تا فردا را بسازیم'],
                            autoStart: true,
                            loop: true,
                        }}
                    />
                </h1>
                <h2 class="landing__subtitle">با آکادمی نقش کلیک، به هر محتوا، جدول ، نمودار و نقشه ای دسترسی داشته باش.
                </h2>
                ...
                <div class="landing-status">
                    ...
                    <div class="landing-status__item">
                        ...
                        <LandingCounter count={3_070}/>
                        <span class="landing-status__text">کاربر توی نقش کلیک ثبت نام کردن</span>
                    </div>
